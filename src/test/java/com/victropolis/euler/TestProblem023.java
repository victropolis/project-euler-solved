...
exceeds n.  As 12 is the smallest abundant number, 1 + 2 + 3 + 4 + 6 = 16, the smallest number that can be written as
 ...
 numbers is less than this limit. Find the sum of all the positive integers which cannot be written as the sum of two
  abundant numbers.
...
*/
    ...
    @Test
    public void test() {
        Assert.assertEquals(4179871L, Problem023.solve(/* change signature to provide required inputs */));
    }
}
