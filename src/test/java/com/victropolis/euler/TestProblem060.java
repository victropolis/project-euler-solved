...
The primes 3, 7, 109, and 673, are quite remarkable. By taking any two primes and concatenating them in any order the
 ...
 primes, 792, represents the lowest sum for a set of four primes with this property. Find the lowest sum for a set of
...
*/
    ...
    @Test
    public void test() {
        Assert.assertEquals(26033L, Problem060.solve(/* change signature to provide required inputs */));
    }
}
