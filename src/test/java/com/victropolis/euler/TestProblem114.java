 ...
 */
public class TestProblem114 {
/*

Description (from https://projecteuler.net/problem=114):

A row measuring seven units in length has red blocks with a minimum length of three units placed on it, such that any
 two red blocks (which are allowed to be different lengths) are separated by at least one black square. There are
...
*/
    ...
    @Test
    public void test() {
        Assert.assertEquals(16475640049L, Problem114.solve(/* change signature to provide required inputs */));
    }
}
