...
10 are given:     1/2 =&nbsp; 0.5   1/3 =&nbsp; 0.(3)   1/4 =&nbsp; 0.25   1/5 =&nbsp; 0.2   1/6 =&nbsp; 0.1(6)   1/7
 ...
 and has a 1-digit recurring cycle. It can be seen that 1/7 has a 6-digit recurring cycle. Find the value of d &lt;
...
*/
    ...
    @Test
    public void test() {
        Assert.assertEquals(983L, Problem026.solve(/* change signature to provide required inputs */));
    }
}
