 ...
 */
public class TestProblem079 {
/*

Description (from https://projecteuler.net/problem=79):
...
asked for in order, analyse the file so as to determine the shortest possible secret passcode of unknown length.

*/

    @Test
    public void test() {
        Assert.assertEquals(73162890L, Problem079.solve(/* change signature to provide required inputs */));
    }
}
