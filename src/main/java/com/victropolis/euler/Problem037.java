 ...
 */
public class Problem037 extends BaseProblem {
    /*
    ...
    left: 3797, 379, 37, and 3. Find the sum of the only eleven primes that are both truncatable from left to right
    ...
    */
    public static long solve(/* change signature to provide required inputs */) {
        throw new UnsupportedOperationException("Problem037 hasn't been solved yet.");
    }
}
